		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Demo Title",
									"targetURL": "#comyedasmmdemo-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comyedasmmdemo-display": {
								"semanticObject": "comyedasmmdemo",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.yedas.mm.demo",
									"url": sap.ui.require.toUrl("com/yedas/mm/demo")
								}
							}
						}
					}
